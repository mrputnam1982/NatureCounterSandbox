...
const initialState = fromJS({
  ...
  userdetails: {
    ...
    notificationSettings: {
      pauseAlert: false,
      pauseNotif: false,
      goalPauseNotif: false,
      stampsPauseNotif: false,
      setCounterpauseNotif: false,
      // healthReportFrequency: 0,
      // articleFrequency: 0,
      progressReportFrequency: 0,
      certificationFrequency: -1,
      trackingReminderFrequency: 0,
      stopCounterReminderFrequency: 0,
      NewArticlesFrequency: -1,
      // achievementFrequency: 0,
      // progressReminderFrequency: 0,
      // counterReminderFrequency: 0,
    },
  },
});
...
export const UserDetail = (state = initialState, action = {}) => {
  switch (action.type) {
    ...
    case ActionTypes.UPDATE_NOTIFICATION_SETTING:
      return state.setIn(['userdetails', 'notificationSettings', action.payload.key], action.payload.value);

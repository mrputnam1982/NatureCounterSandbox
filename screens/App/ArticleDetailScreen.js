    ...
    <SafeAreaView style={styles.ArtContainer}>
      <View source={styles.ArtImageContainer}>
        <Image
          ...
          source={{uri: `${baseUrl}${selectedArticle.image}`}}
        />
      </View>
      <View style={styles.ArticleDetail}>
        <Text style={styles.ArCcategory}>{selectedArticle.category}</Text>
        ...
        <Text style={styles.ArtDescription}>{selectedArticle.description}</Text>
      </View>
    </SafeAreaView>
  );
}

...
const ArticlesSection = ({ article, onPress, user }) => {
  ...
  return (
    <>
      ...
      <StyledView>
        {
          article
            ? <ArticleCard article={article} onPress={handleArticlePress} user={user} />
            : {/*<Text>No articles to show</Text>*/} <Text>Loading articles</Text>
        }
      </StyledView>
    </>
  );
